...
parser.add_argument('-e', '--env-id', type=str, default="Enduro-v0",
                    help="Environment id")
parser.add_argument('-l', '--log-dir', type=str, default="/home/arjun/Documents/Research/FIGAR/clustercode/adv_changed/result/enduro_bug",
...
def run():
    ...
    cmds, notes = create_commands(args.session_name, args.num_workers, args.remotes, args.env_id, args.log_dir, mode=args.mode, visualise=args.visualise)
    if args.dry_run:
